...
Search is also narrowed by [`scope`](../02-api-reference/memory-format.md#scope), so an agent working in one package doesn't have to search memories from unrelated parts of the repo.
