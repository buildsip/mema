...
You may move this memory directory anywhere within ${JSON.stringify(store)}, or leave it where it is. Nesting a memory directory inside another memory directory is an anti-pattern.`;
